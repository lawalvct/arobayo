...
@section('title', 'Create Event - Egbe Arobayo Admin')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="6" required
                                          placeholder="Describe the event details, activities, and what attendees can expect...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-0">
                                <i class="fas fa-check text-success me-2"></i>
                                Set accurate date and location
                            </li>
                        </ul>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (titleInput) {
        titleInput.addEventListener('input', function() {
            // Auto-generate preview or other functionality can be added here
        });
    }
